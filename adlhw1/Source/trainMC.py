...
def main():
    ...
    #==================NO NEED AS LOAD FOR OWN DATASET===================
    ...
    # No --pad_to_max_length then dynamic padding
    ...
    def preprocess_function(examples):
        ...
        tokenized_examples = tokenizer(
            ...
            padding=padding, #false here, DataCollator will do
            truncation=True, #make sure max length must < 512
        )
